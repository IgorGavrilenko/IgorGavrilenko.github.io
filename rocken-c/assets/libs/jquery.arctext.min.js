!function(t,i){function s(i,s,n,a){var e,r=i.text().split(s),o="";r.length&&(t(r).each((function(t,i){e=""," "===i&&(e=" empty",i="&nbsp;"),o+='<span class="'+n+(t+1)+e+'">'+i+"</span>"+a})),i.empty().append(o))}
/*!
	* FitText.js 1.0
	*
